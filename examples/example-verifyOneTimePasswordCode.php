...
// Please fill in a valid one time password code you have received
$receivedOneTimePasswordCode = '';

var_dump($api->verifyOneTimePassword($phoneNumber, $receivedOneTimePasswordCode));
